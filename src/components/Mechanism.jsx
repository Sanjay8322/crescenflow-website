  ...
  return (
    <section className="bg-white py-14 md:py-24 lg:py-32 px-6 md:px-12 lg:px-20 border-t border-border">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <motion.div whileHover={hoverLight} className="bg-white border border-border rounded-2xl p-6 md:p-10 shadow-sm cursor-default">
          ...
          <motion.div whileHover={hoverLight} className="bg-white border border-border rounded-2xl p-6 md:p-10 shadow-sm flex flex-col cursor-default">
